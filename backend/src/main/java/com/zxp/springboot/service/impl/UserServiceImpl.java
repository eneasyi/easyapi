...
import static com.zxp.springboot.constant.UserConstant.USER_LOGIN_STATE;
...
import com.zxp.springboot.constant.CommonConstant;
import com.zxp.springboot.exception.BusinessException;
import com.zxp.springboot.mapper.UserMapper;
import com.zxp.springboot.model.dto.user.UserQueryRequest;
import com.zxp.springboot.model.dto.user.UserUpdatePasswordRequest;
import com.zxp.springboot.model.entity.User;
import com.zxp.springboot.model.enums.UserRoleEnum;
import com.zxp.springboot.model.vo.LoginUserVO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "zxp";
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        String userCity = userQueryRequest.getUserCity();
        ...
        queryWrapper.eq(StringUtils.isNotBlank(userGender), "userGender", userGender);
        queryWrapper.eq(userLevel != null, "userLevel", userLevel);
        queryWrapper.eq(StringUtils.isNotBlank(userCity), "userCity", userCity);
